                        ...
                        <div className="card mb-4">
                            ...
                            {/* src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-chat/ava3.webp" */}
                                ...
                                <div className="d-flex justify-content-center mb-2">
                                    <button type="button" className={`btn ${activeTab === 'my-bookings' ? 'btn-primary' : 'btn-outline-primary'} me-1`} onClick={() => handleTabChange('my-bookings')} >My Bookings</button>
                                    <button type="button" className={`btn ${activeTab === 'my-comments' ? 'btn-primary' : 'btn-outline-primary'} me-1`} onClick={() => handleTabChange('my-comments')} >My Reviews</button>
                                    <button type="button" className={`btn ${activeTab === 'account-settings' ? 'btn-primary' : 'btn-outline-primary'}`} onClick={() => handleTabChange('account-settings')} >Account Settings</button>
                                </div>
                            </div>
                        </div>
                    </div>
