            ...
            <div className="col-lg-6 col-xl-5 order-2 order-lg-1">
              <div className="about_section_content mt-5 mt-lg-0">
                ...
                <p className="wow fadeInLeft" data-wow-delay=".5s">
                  The amazing way to color sit amet, consectetur adipisicing elit, sed do eiusmod incididunt ut labore
                  inventore The amazing way to color sit amet, consectetur. consectetur adipisicing elit, sed do eiusmod
                  incididunt ut labore inventore.
                </p>
                <div className="list_content">
                  <ul>
                    <li className="wow fadeInLeft" data-wow-delay=".5s">
                      <i className="far fa-check-circle"></i> Best Learning School for Kids
                    </li>
                    <li className="wow fadeInLeft" data-wow-delay=".5s">
                      <i className="far fa-check-circle"></i> Indoor/Outdoor Games for Little Kids
                    </li>
                    <li className="wow fadeInLeft" data-wow-delay=".6s">
                      <i className="far fa-check-circle"></i> Professional & Qualified Teacher
                    </li>
                    <li className="wow fadeInLeft" data-wow-delay=".6s">
                      <i className="far fa-check-circle"></i> Indoor/Outdoor Games for Little Kids
                    </li>
