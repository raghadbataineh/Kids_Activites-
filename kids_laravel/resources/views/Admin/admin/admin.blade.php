...
<div class="card">
  ...
  <a href="{{ url('/adminuser/create') }}"><button class=" btn btn-primary" tabindex="0" type="button"><span><i
    class="mdi mdi-plus me-0 me-sm-1"></i><span class="d-none d-sm-inline-block">Add
    Admin</span></span></button></a>
