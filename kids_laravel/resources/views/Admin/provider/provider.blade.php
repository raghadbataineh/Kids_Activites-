...
<div class="card">
  ...
  <a href="{{ url('/provider/create') }}"><button class=" btn btn-primary" tabindex="0" type="button"><span><i
    class="mdi mdi-plus me-0 me-sm-1"></i><span class="d-none d-sm-inline-block">Add
    Provider</span></span></button></a>
    ...
    <table class="datatables-customers-lists table">
      <thead class="table-light">
        <tr>
          ...
          <th class="text-nowrap">Provider Id</th>
          <th>Address</th>
          <th>Store</th>
